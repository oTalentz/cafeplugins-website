...
const I18N = {
  ...
  translations: {
    'pt-BR': {
      ...
      'faq.a1': 'Após o pagamento, você recebe o link de download por e-mail e/ou também na sua conta, na seção "Minhas compras". A licença já vem embutida no plugin.',
    ...
    'pt-PT': {
      ...
      'faq.title': 'FAQ',
      'faq.q1': 'Como recebo o plugin após a compra?',
      'faq.a1': 'Após o pagamento, recebe o link de download por e-mail e/ou também na sua conta, na secção "Minhas compras". A licença já vem embutida no plugin.',
      'faq.q2': 'Quais formas de pagamento?',
      'faq.a2': 'PIX (confirmação automática) e cartão de crédito.',
      'faq.q3': 'Funciona offline?',
      'faq.a3': 'Sim. A licença é validada na inicialização e periodicamente, mas o plugin funciona normalmente entre as verificações.',
    ...
    'en': {
      ...
      'faq.a1': 'After payment, you receive the download link by email and/or in your account under "My purchases". The license is already embedded in the plugin.',
    ...
    'es': {
      ...
      'faq.a1': 'Después del pago, recibes el enlace de descarga por correo y/o también en tu cuenta, en la sección "Mis compras". La licencia ya viene integrada en el plugin.',
